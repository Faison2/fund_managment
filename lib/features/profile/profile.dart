...
class _ProfileScreenState extends State<ProfileScreen>
      ...
      builder: (ctx) => StatefulBuilder(
        builder: (ctx, setDialogState) {
          ...
          return _buildPasswordDialog(
            ...
            onToggleCurrent: () => setDialogState(() => obscureCurrent = !obscureCurrent),
            onToggleNew:     () => setDialogState(() => obscureNew     = !obscureNew),
            onToggleConfirm: () => setDialogState(() => obscureConfirm = !obscureConfirm),
  ...
  static Widget _buildPasswordDialog({
    ...
    required bool obscureCurrent, required bool obscureNew, required bool obscureConfirm,
    required bool isSubmitting, required String? dialogError,
    required VoidCallback onToggleCurrent,
        ...
        child: Column(
          ...
          children: [
            ...
            Row(children: [
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                      color: border, borderRadius: BorderRadius.circular(8)),
                  child: Icon(Icons.close_rounded, size: 16, color: txtS),
                ),
              ),
            ]),
            ...
            _pwFieldStatic(
              ...
              obscure: obscureCurrent, onToggle: onToggleCurrent,
            ...
            _pwFieldStatic(
              ...
              obscure: obscureNew, onToggle: onToggleNew,
              enabled: !isSubmitting, isDark: isDark,
              border: border, txtP: txtP, txtH: txtH,
            ),
  ...
  Widget _pwField({
    ...
    required Color border, required Color txtP, required Color txtH,
  }) => _pwFieldStatic(
    controller: controller, hint: hint, obscure: obscure,
    onToggle: onToggle, enabled: enabled, isDark: isDark,
    border: border, txtP: txtP, txtH: txtH,
  );
  ...
  Widget _buildDecorativeBackground() => AnimatedBuilder(
  ...
  Widget _buildQuickStats(_PS s) => Padding(
  ...
  Widget _sectionLabel(String text) => Padding(
    ...
    child: Row(children: [
      ...
      const SizedBox(width: 8),
      Text(text.toUpperCase(), style: TextStyle(fontSize: 10,
          fontWeight: FontWeight.w700, color: _txtH, letterSpacing: 2.0)),
    ]),
  );
    ...
    child: Padding(
      ...
      child: Row(children: [
        ...
        Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          const SizedBox(height: 4),
          Text(f.value, style: TextStyle(fontSize: 15, color: _txtP,
