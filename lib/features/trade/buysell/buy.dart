...
class _BuyApi {
  static const _url =
      'https://portaluat.tsl.co.tz/DSEAPI/Home/BuyShares';
...
class BuySharesPage extends StatefulWidget {
  ...
  const BuySharesPage({Key? key, this.symbol, this.marketPrice})
      : super(key: key);

  @override
  State<BuySharesPage> createState() => _BuySharesPageState();
}
...
class _BuySharesPageState extends State<BuySharesPage>
  ...
  Future<void> _submit() async {
    ...
    try {
      final result = await _BuyApi.buyShares(
...
// ─────────────────────────────────────────────────────────────────────────────
// SHARED WIDGETS  (used by both Buy & Sell screens)
// ─────────────────────────────────────────────────────────────────────────────
