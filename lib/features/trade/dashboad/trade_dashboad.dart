...
class _TradeDashboardState extends State<TradeDashboard>
      ...
      leading: IconButton(
        icon: Container(
          ...
          child: const Icon(Icons.menu_rounded,
              size: 16, color: PastelColors.txtPrim),
        ),
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Row(children: [
                      _miniStat(
                          'Day P&L', '+TZS 48,200', const Color(0xFF4ADE80)),
                      _vDivider(),
            ...
            child: GestureDetector(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  boxShadow: [
                    BoxShadow(
                      color: PastelColors.red.withOpacity(0.3),
                      blurRadius: 16,
                      offset: const Offset(0, 6),
                    ),
                  ],
  ...
  Widget _buildAllocationSection() {
    return Column(
      children: [
        const TradeSectionHeader(
            title: 'Allocation', icon: Icons.pie_chart_outline_rounded),
        Padding(
          padding: const EdgeInsets.symmetric(horizontal: 16),
          child: Container(
          ...
          child: GestureDetector(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                borderRadius: BorderRadius.circular(14),
                border: Border.all(
                    color: PastelColors.accent.withOpacity(0.2)),
              ),
              child: Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: const [
  ...
  Widget _buildBottomNav() {
    return BottomAppBar(
      ...
      child: Container(
        decoration: const BoxDecoration(
          border: Border(
            top: BorderSide(color: PastelColors.border, width: 1),
          ),
        ),
        child: SizedBox(
          height: 64,
  ...
  Widget _navItem(int idx, IconData icon, String label) {
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          color: sel ? PastelColors.accentLt : Colors.transparent,
                  ...
                  child: AnimatedContainer(
                    ...
                    decoration: BoxDecoration(
                      gradient: sel
                          ...
                          colors: PastelColors.fabGrad)
                          : null,
                      color: sel ? null : PastelColors.bg,
                      borderRadius: BorderRadius.circular(8),
                    ),
          ...
          SizedBox(
            ...
            child: CustomPaint(
              painter: LineChartPainter(
                data: widget.data,
                lineColor: PastelColors.accent,
                fillColor: PastelColors.accent.withOpacity(0.08),
              ),
              size: Size.infinite,
            ),
          ),
